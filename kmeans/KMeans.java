...
public class KMeans extends Configured implements Tool{
    ...
    public static boolean stopIteration(Configuration conf) throws IOException{
        ...
        Path pervCenterFile=new Path("/home/hadoop/test/input/centers");
        Path currentCenterFile=new Path("/home/hadoop/test/output/part-r-00000");
    ...
    public int run(String[] args) throws Exception {
        ...
        //质心文件每行的第一个数字是索引
        FileInputFormat.setInputPaths(job, "/home/hadoop/test/input/centers");
        Path outDir=new Path("/home/hadoop/test/output");
    ...
    public static void main(String[] args) throws Exception {
        ...
        //样本数据文件中每个样本不需要标记索引
        Path dataFile=new Path("/home/hadoop/test/input/test.in");
        ...
        //迭代完成后再执行一次mapper，输出每个样本点所属的分类--在/home/hadoop/test/output2/part-m-00000中
        //质心文件保存在/home/hadoop/test/input/centers中
        Job job=new Job(conf);
        job.setJarByClass(KMeans.class);
          
        FileInputFormat.setInputPaths(job, "/home/hadoop/test/input/centers");
        Path outDir=new Path("/home/hadoop/test/output2");
        fs.delete(outDir,true);
        FileOutputFormat.setOutputPath(job, outDir);
